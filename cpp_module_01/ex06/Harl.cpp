...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/30 18:39:59 by tuzan             #+#    #+#             */
/*   Updated: 2025/10/30 18:39:59 by tuzan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Harl::debug(void)
{
	...
	std::cout << "I love having extra bacon for my "
			  ...
			  << "special-ketchup burger." << std::endl;
...
void Harl::info(void)
{
	...
	std::cout << "I can't believe adding extra "
			  << "bacon cost more money." << std::endl;
